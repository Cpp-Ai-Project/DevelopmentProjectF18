...
class MyGame(object):
    ...
    def do_init(self):
        ...
        # counter used to help count seconds for increasing difficulty
        self.counter = 0
                ...
                if self.state != MyGame.WELCOME:
                    ...
                    if self.state == MyGame.PLAYING:
                        ...
                        if keys[pygame.K_RIGHT] or keys[pygame.K_d]:
                            ...
                            # the spaceship clockwise by 25 degrees
                            self.spaceship.angle -= 25
                            self.spaceship.angle %= 360

                        if keys[pygame.K_LEFT] or keys[pygame.K_a]:
                            # when pressing "d" or "right arrow" rotate
                            # the spaceship counter clockwise by 25 degrees
                            self.spaceship.angle += 25
                            self.spaceship.angle %= 360
    ...
    def draw(self):
        ...
        if self.state != MyGame.WELCOME:
            ...
            # create and display text for score
            ...
            # create and display the text for timer
            time_txt = self.medium_font.render(str(self.timer//10),\
                                               True, (0, 155, 0))
            draw_centered(time_txt, self.screen, (400, time_txt.get_height() + 10))
